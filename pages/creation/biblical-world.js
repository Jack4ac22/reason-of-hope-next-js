          ...
          <div className="px-4 py-5 my-1 text-center">
            ...
            <div className="col-lg-6 mx-auto">
              <p className="lead mb-4">
                ...
                النقد الموجَّه إلى الكتاب المقدس.
              </p>
              <p className="lead mb-4">
                تتضمن هذه الفئة مجموعة المقالات والدراسات المرتبطة بالتاريخ
                المسجل في الكتاب المقدس، بالإضافة إلى الدراسات المرتبطة بقضية
                طوفان سفر التكوين وفلك نوح. سيتم إرفاق الموضوعات المرتبطة
                بالمواقع الجغرافية وسواها مع هذه المجموعة.
              </p>
