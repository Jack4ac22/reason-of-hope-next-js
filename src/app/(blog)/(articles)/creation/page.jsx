...
export default function CreationPage() {
  const biblical_world_section_object = {
    ...
    articles: getArticlesByCategory("العالم-التوراتي"),
    reversed: false,
  }
  const creation_gospel_section_object = {
    ...
    articles: getArticlesByCategory("الكتاب-المقدس-والإنجيل"),
    reversed: true,
  }
  const dino_section_object = {
    ...
    articles: getArticlesByCategory("الديناصورات-والتأريخ"),
    reversed: false,
  }
  const evolution_ethics_section_object = {
    ...
    articles: getArticlesByCategory("التطور-ونتائجه"),
    reversed: true,
  }
