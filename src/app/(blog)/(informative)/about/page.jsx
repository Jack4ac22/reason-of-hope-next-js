    ...
    <main className="flex justify-center uni-text-color select-none">
      <div className="m-8 w-full md:max-w-2xl ">
        ...
        <section id="team">
          ...
          <p>
            إننا نعمل بإيمان وثقة بأن الله سيُبارك عملنا وسيُستخدمه لمجد اسمه ولنشر ملكوته.
          </p>
          <p>
