    ...
    <main className="max-w-4xl mx-auto p-6" dir="ltr">
      ...
      <ul className="list-disc pl-5 space-y-8">
        ...
        <li>
          ...
          <p className="text-right " dir="rtl">
            كتاب (الحزن: طريق عودتك إلى السلام) (1997) لجيمس آر. وايت قيد التدقيق والتحرير النهائي. يقدم هذا العمل القصير والرعوي تعزية ومشورة كتابية للمتألمين.
          </p>
        </li>
        ...
        <li>
          ...
          <p className="text-right " dir="rtl">
            إلى جانب الكتب والتطبيقات، نقوم بترجمة مقالات صغيرة وكتيبات لاهوتية وموارد عملية مختلفة.
          </p>
        </li>
      </ul>
    </main>
