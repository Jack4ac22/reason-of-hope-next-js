  ...
  return (
    <div className='m-9'>
      ...
      <div className="container mx-auto">
        ...
        {/* <!-- Margin --> */}
        <div className="bg-slate-100 m-5">Test Margin</div>
        <div className="bg-slate-100 ml-5">Test Margin</div>
        <div className="bg-slate-100 mr-5">Test Margin</div>
        <div className="bg-red-400 mt-5">Test Margin</div>
        <div className="bg-orange-100 mb-5">Test Margin</div>
        {/* <!-- Padding --> */}
        <div className="bg-red-100 p-5">Test Padding</div>
        <div className="bg-pink-100 pl-5">Test Padding</div>
        <div className="bg-blue-100 pr-5">Test Padding</div>
        <div className="bg-green-100 pt-5">Test Padding</div>
        <div className="bg-yellow-100 pb-5">Test Padding</div>
        <div className="bg-orange-100 pt-[50px]">Test Padding</div>
        {/* <!-- Space Between X --> */}
