export default function PageSizing() {
  return (
    <>
      {/* Width  */}
      <div className="bg-black text-white w-32">Test width</div>
      <div className="bg-black text-white w-48">Test width</div>
      <div className="bg-black text-white w-96">Test width</div>
      {/* Percentages  */}
      <div className="bg-yellow-400 text-white w-1/4">Test width 1/4</div>
      <div className="bg-yellow-400 text-white w-1/3">Test width 1/3</div>
      <div className="bg-yellow-400 text-white w-1/2">Test width 1/2</div>

      {/* Width of the viewport  */}
      <div className="bg-blue-400 text-white w-screen">Test width 1/2</div>

      {/* 100% of container  */}
      <div className="bg-red-400 text-white w-full">Test width 1/2</div>

      {/* min/max content  */}

      {/* Arbitrary width  */}
      <div className="bg-green-400 text-white w-[500px]">Test width 1/2</div>

      {/* Max Width  */}
      <div className="bg-purple-400 text-white max-w-xl">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Accusamus accusantium tempore sequi quis soluta architecto obcaecati distinctio, nam esse ea a repudiandae dolore vero suscipit quae ratione sint nisi tenetur.</div>


      {/* Height (Most of the same options as widths)  */}
      <div className="flex items-end">
        <div className="bg-orange-500 w-20 h-12">Hellow</div>
        <div className="bg-orange-500 w-20 h-24">Hellow</div>
        <div className="bg-orange-500 w-20 h-36">Hellow</div>
        <div className="bg-orange-500 w-20 h-48">Hellow</div>
        <div className="bg-orange-500 w-20 h-72">Hellow</div>
        <div className="bg-orange-500 w-20 h-96">Hellow</div>
      </div>
      ...
      {/* Full screen height  */}
        <div className="bg-blue-500 w-20 h-screen">Hellow</div>
    </>
  )
}
