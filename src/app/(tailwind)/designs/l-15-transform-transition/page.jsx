export default function Page() {
  return (
    <>
      <button
        className="px-8 py-2 m-24 text-white bg-blue-500 rounded hover:bg-blue-700"
      >
        Click me
      </button>
      ...
      {/* Transition  */}
      <button
        className="px-8 py-2 m-24 text-white bg-blue-500 rounded hover:bg-blue-700 hover:opacity-20 transition duration-1000 ease-in-out"
      >
        Click me
      </button>
      {/* <!-- Transition & Transform --> */}
      <button
        className="px-8 py-2 m-24 text-white bg-blue-500 rounded hover:bg-blue-700 hover:rotate-12 transition duration-1000 ease-in"
      >
        Click me
      </button>
      ...
      <img src="/tailwind/img1.jpg" alt="" className='w-48 hover:rotate-180 hover:scale-75 hover:skew-x-12 transition duration-2000' />
