...
export default function FallaciesList({ article }) {
  ...
  const fallaciesData = {
    ...
    "مغالطة التشعُّب": {
      ...
      video: "kYvRFMLLtQs",
      fallacy_article: "logic/bifurcation",
    },
