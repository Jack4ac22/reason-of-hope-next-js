    ...
    <section className="mt-6 uni-text-color">
      ...
      <Suspense fallback={<CardsListSkeleton />}>
        <div className="mx-4 border-4 rounded-xl page-layer-container">
          ...
          {/* articles cards */}
          <DisplayedCards articles={articles} order={searchParams.get('order')?.toString()} perPage={parseInt(searchParams.get('perPage'))} page={parseInt(searchParams.get('page')) || 1} />
          {/* pagination */}
