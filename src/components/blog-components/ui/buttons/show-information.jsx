  ...
  return (
    <>
      ...
      <div className="group animate duration-200 focuse:outline-2">
        ...
        <button className="relative flex items-center text-mainBrand-500 cursor-pointer hover:text-mainBrand-600 dark:text-mainBrand-300 dark:hover:bg-mainBrand-200
        focus:text-xl focus:drop-shadow-2xl focus:outline-2"
          ...
          <div className="relative">
            ...
            shadow-md">
              <span className="inline-block text-sm text-center leading-tight text-">{inlineText}</span>
            </div>
          </div>
        </button>
