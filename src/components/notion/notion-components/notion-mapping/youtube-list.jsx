...
export default function YoutubeListEmbeded({ videoUrl, videoCaption, videoType }) {
    ...
    <div className="my-4 print:hidden">
      ...
      {videoCaption && (
        <p className="text-sm text-center mt-2">
          {videoCaption}
          <Link href={videoUrl} target="_blank" className="section-link"> شاهد من خلال منصة يوتيوب</Link>
        </p>
      )}
    </div>
  );
