        ...
        )}
        {
          isHomePage && (
            <div className="text-center">
              <h2 className="text-3xl font-extrabold text-gray-900 sm:text-5xl">Reason of hope</h2>
              <p className="mx-auto mt-4 max-w-sm text-gray-500">
                A platform that produce and distribute resources that facilitate the accesibility of the Gospel to the world.
              </p>
              <a
                href="#"
        ...
        <div className="mx-auto max-w-screen-xl px-4 pb-8 pt-16 sm:px-6 lg:px-8 lg:pt-24">
          ...
          <div className="mt-8 border-t border-gray-100 pt-8 flex flex-col items-center">
            <p className="text-xs text-gray-500">
              &copy; {currentYear} Reason of Hope. All rights reserved.
            </p>
          </div>
        </div>
      </footer >
