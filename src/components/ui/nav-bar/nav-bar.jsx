    ...
    <nav className="bg-blue-700 border-b border-blue-500">
          ...
          >
            ...
            <div className="hidden md:ml-6 md:block">
              <div className="flex space-x-2">
                <Link
                  href="/"
                  className={`text-white hover:bg-gray-900 hover:text-white rounded-md px-3 py-2 ${path === '/' ? 'bg-gray-700' : ''}`}
                >Home
                </Link>
                <Link
                  href="/translations"
      ...
      {isMobileMenuOpen && (<div className='md:hidden' id="mobile-menu">
        <div className="space-y-1 px-2 pb-3 pt-2">
          <Link
            href="/"
            className={`text-gray-300 hover:bg-gray-700 hover:text-white block rounded-md px-3 py-2 text-base font-medium ${path === '/' ? 'bg-gray-700' : ''}`}
            onClick={handleMobileMenuLinkClick}
          >Home</Link>
          <Link
            href="/translations"
            className={`text-gray-300 hover:bg-gray-700 hover:text-white block rounded-md px-3 py-2 text-base font-medium ${path === '/translations' ? 'bg-gray-700' : ''}`}
            onClick={handleMobileMenuLinkClick}
          >Translations</Link>
          {
            session && (
